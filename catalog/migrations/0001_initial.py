# Generated by Django 2.2.1 on 2019-06-05 10:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LC', models.CharField(help_text='Enter the LC number', max_length=50, verbose_name='Library of Congress number')),
                ('status', models.CharField(blank=True, choices=[('y', 'Read'), ('c', 'Currently Reading'), ('n', 'Not Read')], default='n', help_text='Read status', max_length=1)),
